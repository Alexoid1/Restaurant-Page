const menuPage = () => {
  ...
  combol21.textContent =
    "Family Pizza, pineapple, Dacotta Chesse, Mushrooms, Salami";
  ...
  combol41.textContent =
    "Medium Pizza, pineapple, Dacotta Chesse, Mushrooms, Salami";
